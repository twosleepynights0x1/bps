...
## ✨ Примечание 
- - 🌐 **Сбор данных** — сервис собирает MAC адрес для определения устройства ( На это могут жаловаться некоторые антивирусы)

[![VirusTotal Scan](https://img.shields.io/badge/VirusTotal-Scan-green?style=for-the-badge)](https://www.virustotal.com/gui/file/66832ac561b14d7a0db035d76338fe14291f913c0e7320ce6c12f4854ab1e218?nocache=1 "Посмотреть полный отчет сканирования на VirusTotal")
